...
public class Test {
	...
	public static void main(String[] args) throws Exception {
		...
		out.println("POST /mobile2/reservation.php HTTP/1.1");
		out.println("Host: resortgymmt.flexgym.biz");
		out.println("Cookie: " + sessionID);
		out.println("Connection: keep-alive");
		out.println("Content-Length: 146");
		...
		out.println("Referer: https://resortgymmt.flexgym.biz/mobile2/reservation.php");
		out.println("Accept-Encoding: gzip, deflate, br");
		out.println("Accept-Language: ko-KR,ko;q=0.9,en-US;q=0.8,en;q=0.7");
		out.println();
		out.println("isWeek=1&page=1&pagesize=10&Date=2022-08-01&LC=C&flag=&idx=&payIdx=&SSIdx=&ReserveDate=2022-08-02&codeSS033=62839774&codeSS02=0&ClassR=0&Trainer=0");
		out.println();
